...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse" style="background-color: pink">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    <img src="{{ asset('assets/img/avatars/profile.png') }}" alt
                ...
                <li>
                    <a href="{{ url('profile_edit', auth()->user()->id) }}" class="dropdown-item"
                ...
                <li>
                    <a href="{{ route('changeLanguage', 'th') }}" class="dropdown-item">
                        <i class="fa-solid fa-flag me-2"></i>
                        <span class="align-middle">Thiland</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('changeLanguage', 'ch') }}" class="dropdown-item">
                        <i class="fa-solid fa-flag me-2"></i>
