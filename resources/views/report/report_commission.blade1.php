                                        ...
                                        @foreach ($reports as $key => $report)
                                            @php
                                                $totalCommissionPrice +=
                                                    ($report->girl_commission / 100) * $report->price;
                                            @endphp
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                <td>{{ $report->girl_commission }} %</td>
                                                <td>{{ ($report->girl_commission / 100) * $report->price }}
                                                    THB</td>
                                                <td>{{ $report->state }}</td>
                                                <td>{{ date('d-m-Y', strtotime($report->order_date)) }}</td>
                                                <td><a href="" class="btn btn-info">Girl History</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{ $totalCommissionPrice }} THB</td>
                                            <td colspan="3"></td>
                                        </tr>
                                    </tfoot>
                                </table>
